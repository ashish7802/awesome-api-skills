...
The registry maintains metadata, category indexes, and dependency relationships for all **116 skills**.

## Graph Data

The complete dependency and integration graph is located in `registry/graph.json`:

- **Nodes**: 116 unique skill nodes with version, categories, and agent compatibility.
- **Edges**: 248 directed relationships categorizing stacks, prerequisites, and alternatives.
