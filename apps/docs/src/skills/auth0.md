...
<div class="trust-panel">
  ...
  <div class="trust-doc-link"><a href="https://auth0.com/docs/api/management/v2" target="_blank" rel="noopener">Official Documentation ↗</a></div>
</div>
...
- **integrates with** → [nextjs](/skills/nextjs)
