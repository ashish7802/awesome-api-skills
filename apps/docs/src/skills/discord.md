...
<p class="skill-meta">Messaging</p>
...
<div class="trust-panel">
  ...
  <div class="trust-doc-link"><a href="https://discord.com/developers/docs/intro" target="_blank" rel="noopener">Official Documentation ↗</a></div>
</div>


## Graph

- **integrates with** → [express](/skills/express)
