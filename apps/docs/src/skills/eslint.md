...
<div class="trust-panel">
  ...
  <div class="trust-grid">
    ...
    <div class="trust-item">
      ...
      <span class="trust-val">javascript</span>
    </div>
    <div class="trust-item">
  ...
  <div class="trust-doc-link"><a href="https://eslint.org/docs/latest/" target="_blank" rel="noopener">Official Documentation ↗</a></div>
</div>


## Graph

- **alternative to** → [biome](/skills/biome)
- **works well with** → [prettier](/skills/prettier)
