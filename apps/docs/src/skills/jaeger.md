...
<div class="trust-panel">
  ...
  <div class="trust-doc-link"><a href="https://www.jaegertracing.io/docs/" target="_blank" rel="noopener">Official Documentation ↗</a></div>
</div>


## Graph

- **depends on** → [opentelemetry](/skills/opentelemetry)
- **integrates with** → [grafana](/skills/grafana)
