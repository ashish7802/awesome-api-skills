...
<p class="skill-meta">Communications · Developer Tools</p>
...
<div class="trust-panel">
  ...
  <div class="trust-doc-link"><a href="https://docs.novu.co" target="_blank" rel="noopener">Official Documentation ↗</a></div>
</div>


## Graph

- **integrates with** → [resend](/skills/resend)
- **integrates with** → [twilio](/skills/twilio)
