...
<p class="skill-meta">Authentication · Enterprise</p>
...
<div class="trust-panel">
  ...
  <div class="trust-doc-link"><a href="https://developer.okta.com/docs/reference/" target="_blank" rel="noopener">Official Documentation ↗</a></div>
</div>


## Graph

- **implements** → [oauth2](/skills/oauth2)
- **implements** → [openid-connect](/skills/openid-connect)
