...
1. Complete [`github-profile.md`](github-profile.md) checklist
2. Upload `social-preview.png` in GitHub Settings → Social preview
3. Create tag `v1.0.0` with body from [`github-release.md`](github-release.md)
4. Pick one or more platform drafts above — each is written for its audience
